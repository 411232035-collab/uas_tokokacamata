...
<div class="card-dark p-4 animate-fade">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mb-4">
        <div>
            <h4 class="mb-1">Tambah Stok</h4>
            <p class="text-muted mb-0">Tambah atau perbarui ketersediaan stok.</p>
        </div>
    ...
    <form action="{{ route('stocks.store') }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <input name="stock_date" type="date" class="form-control" required>
            </div>
        </div>
